...
class TFTScreen : Screen {
    @Composable
    override fun Content() {

        val navigator = LocalNavigator.currentOrThrow

        val screenModel: TFTScreenModel = getScreenModel()
        ...
        Scaffold(
            topBar = {
                TopBar(
                    title = stringResource(MR.strings.text_from_text),
            ...
            bottomBar = {
                BottomArea.TextFromText(
                    onSendClick = { message ->
                        screenModel.onEvent(TFTEvent.SendMessage(message))
